  ...
  const renderHoverLetters = (text) => {
    ...
    return (
      <>
        ...
        <header className="w-full ml-12 my-10">
              <div className="lowercase font-light ml-8 mb-4 text-gray-500 text-9xl">
                <h1 className="text-sm tracking-wider text-gray-500 mt-8 mb-4">
                Fullstack Projects
                </h1>
