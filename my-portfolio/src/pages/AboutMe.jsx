export default function AboutMe() {
    return (
      <div className="container mx-auto mt-20 p-4">
        <div className="max-w-3xl mx-auto p-8 border border-transparent rounded-lg shadow-xl mb-8 bg-gradient-to-r from-slategrey to-coolgrey text-white">
        ...
        <div className="max-w-3xl mx-auto p-8 border border-transparent rounded-lg text-gray-700 shadow-xl mb-8 bg-white">
          <h1 className="text-4xl font-bold mb-6 text-gray-700">Skills</h1>
          <ul className="list-disc pl-5 space-y-4">
            <li className="text-lg"><span className="font-bold">Programming languages:</span> Java, JavaScript, Python, SQL</li>
            <li className="text-lg"><span className="font-bold">Frameworks/Libraries:</span> React, Express</li>
            <li className="text-lg"><span className="font-bold">Tools:</span> Git, Docker, Excel, PowerPoint</li>
            <li className="text-lg"><span className="font-bold">Languages:</span> English, German, Tigrinya</li>
          </ul>
        </div>
