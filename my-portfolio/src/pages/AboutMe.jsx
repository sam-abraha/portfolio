...
export default function AboutMe() {
  return (
    <div className="bg-primary min-h-full flex flex-col items-center mt-10 py-16 px-4">
      <div className="prose lg:prose-gray mx-auto text-gray-700">
        <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-4">
            <li className="text-lg flex flex-col sm:flex-row justify-between items-center">
            ...
            <li className="flex flex-col sm:flex-row justify-between items-center text-lg">
